...
bool mtsCISSTToROS(const prmPositionCartesianSet & cisstData, geometry_msgs::PoseStamped & rosData,
                   const std::string & debugInfo)
{
    if (mtsCISSTToROSHeader(cisstData, rosData, debugInfo)) {
        rosData.header.frame_id = cisstData.ReferenceFrame();
...
bool mtsCISSTToROS(const vct6 & cisstData, geometry_msgs::Wrench & rosData,
                   const std::string &)
{
...
bool mtsCISSTToROS(const vct6 & cisstData, geometry_msgs::WrenchStamped & rosData,
                   const std::string & debugInfo)
{
    mtsCISSTToROSHeader(rosData, debugInfo);
